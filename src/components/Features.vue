  ...
  <div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      ...
      <div class="mb-10 md:mb-16">
        <h2 class="text-gray-800 text-2xl lg:text-4xl xl:text-6xl font-bold text-center mb-4 md:mb-6">Our competitive advantage</h2>

        <p class="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto">
          This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written
      ...
      <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-12 xl:gap-16">
        ...
        <div class="flex flex-col items-center">
          ...
          <h3 class="text-lg md:text-xl font-semibold text-center mb-2">Cloud</h3>
          <p class="text-gray-500 text-center mb-2">
            Filler text is dummy text which has no meaning however looks very similar to real text.
          </p>
          <a href="#" class="text-indigo-500 hover:text-indigo-600 active:text-indigo-700 font-bold transition duration-100">More</a>
        ...
        <div class="flex flex-col items-center">
          ...
          <h3 class="text-lg md:text-xl font-semibold text-center mb-2">Speed</h3>
          <p class="text-gray-500 text-center mb-2">
            Filler text is dummy text which has no meaning however looks very similar to real text.
          </p>
          <a href="#" class="text-indigo-500 hover:text-indigo-600 active:text-indigo-700 font-bold transition duration-100">More</a>
        ...
        <div class="flex flex-col items-center">
          ...
          <h3 class="text-lg md:text-xl font-semibold text-center mb-2">Support</h3>
          <p class="text-gray-500 text-center mb-2">
            Filler text is dummy text which has no meaning however looks very similar to real text.
          </p>
          <a href="#" class="text-indigo-500 hover:text-indigo-600 active:text-indigo-700 font-bold transition duration-100">More</a>
        ...
        <div class="flex flex-col items-center">
          ...
          <h3 class="text-lg md:text-xl font-semibold text-center mb-2">Dark Mode</h3>
          <p class="text-gray-500 text-center mb-2">
            Filler text is dummy text which has no meaning however looks very similar to real text.
          </p>
          <a href="#" class="text-indigo-500 hover:text-indigo-600 active:text-indigo-700 font-bold transition duration-100">More</a>
