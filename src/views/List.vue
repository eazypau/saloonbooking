      ...
      <div>
        <div v-for="(item, index) in saloonList" :key="index" class="card">
          ...
          <div>
            <button
              @click="
                isLogin ? (visible = true) : (needUser = true),
                  (indexOfDoc = index)
              "
              class="
                py-1
          ...
          <div v-if="visible" class="popOutWindow">
            <div class="bookingWindow">
              ...
              <div class="mb-5">
                ...
                <p class="text-sm">{{ saloonList[indexOfDoc].workingHour }}</p>
                <p class="text-sm">{{ saloonList[indexOfDoc].shopAddress }}</p>
              </div>
              <div
                class="
                ...
                >
                  <div class="flex flex-col items-start md:col-span-1">
                    <div class="flex flex-col mb-1">
                      ...
                      <select
                        class="border-2 rounded-md p-1 bg-white border-black"
                        name="pax"
                        id="pax"
                        v-model="pax"
                        required
                  ...
                  >
                    <div class="flex flex-col">
                      ...
                      <input
                        class="border-black md:w-max w-36"
                        type="date"
                        v-model="date"
                        required
                      />
                    ...
                    <div class="flex flex-col">
                      ...
                      <input
                        class="bg-white border-black max-w-max"
                        type="time"
                        name="time"
                        v-model="time"
                        required
...
export default defineComponent({
  ...
  methods: {
    ...
    completeBooking(
      saloonBookedId: string,
      saloonBookedName: string,
      saloonStartTime: string,
      saloonEndTime: string
    ) {
      const auth = getAuth();
